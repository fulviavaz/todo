  ...
  return (
    ...
    >
      ...
      <div className="flex  items-center justify-center  py-4 px-4 w-full">
        ...
        transition-colors duration-300">Concluir</button>
              <button className="bg-red-800 hover:bg-red-700 text-white font-bold py-2 px-4 
        rounded border-0 cursor-pointer transition-colors duration-300">x</button>
      </div>
    </div>
  );
}
